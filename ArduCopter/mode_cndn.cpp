...
{
    int cross = 0;
    const Vector2f *vp, cp(loc.lat/1e7, loc.lng/1e7);
...
ModeCNDN::ModeCNDN()
{
    ...
    {
        // area1
        vecAreas.push_back({pos:{Vector2f(36.11120270f,127.5232490f),Vector2f(Vector2f(36.11129479f,127.5240063f),Vector2f(36.11109010f,127.5240575f),Vector2f(36.11099559f,127.5232995f)}});
        // area2
